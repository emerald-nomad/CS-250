...
void Test3() {
    cout << endl << "---------------------------------------" << endl;
    cout << "TEST 3: Write to a file that isn't opened"
    << endl << endl;
    RecordManager record;
    ...
    cout << endl << "END OFF TEST 3" << endl;
}

void Test4() {
    cout << endl << "---------------------------------------" << endl;
    cout << "TEST 4: Close a file that isnt opened"
    << endl << endl;
    RecordManager record;
...
void Test5() {
    cout << endl << "---------------------------------------" << endl;
    cout << "Test 5: Try to open more than max # of files"
    << endl << endl;
    RecordManager record;
    ...
    try {
        ...
        record.OpenOutputFile("Test5_F.txt");
    }
    catch (runtime_error& ex) {
        cout << "Error: " << ex.what() << endl;
    }
